...
namespace PrisonExtensions.ThingComps
{
...
//        public LawDef lawBroken;
        ...
        public bool ShouldBeTransfered
        {
            get
            {
                ...
                return((haulTarget != null) && (parent.Position.GetRoom(Find.VisibleMap) != haulTarget.GetRoom())
                );
            }
        }
...
//                RemoveHediffDefOn(prisoner, Data.HediffDefOf.HandCuffed,
//                    prisoner.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.LeftHand));
//                RemoveHediffDefOn(prisoner, Data.HediffDefOf.HandCuffed,
//                    prisoner.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.RightHand));
//            }
//            // Check leg shackles
...
//            {
//                // Make sure hediffs are removed
//                RemoveHediffDefOn(prisoner, Data.HediffDefOf.LegShackled,
//                    prisoner.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.LeftLeg));
//                RemoveHediffDefOn(prisoner, Data.HediffDefOf.LegShackled,
//                    prisoner.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.RightLeg));
//            }
//            // Check collars
...
//            }
        ...
        {
            if ((pawn == null) || (hediffDef == null) || (bodyPartRecord == null))
            {
                return;
            }
...
//                {
//                    ApplyHediffDefOn(pawn, Data.HediffDefOf.HandCuffed,
//                        pawn.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.LeftHand));
//                    ApplyHediffDefOn(pawn, Data.HediffDefOf.HandCuffed,
//                        pawn.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.RightHand));
//                }
//                if (bodyPartGroup == BodyPartGroupDefOf.Legs)
//                {
//                    ApplyHediffDefOn(pawn, Data.HediffDefOf.LegShackled,
//                        pawn.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.LeftLeg));
//                    ApplyHediffDefOn(pawn, Data.HediffDefOf.LegShackled,
//                        pawn.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.RightLeg));
//                }
//            }
        }
...
//                if (bodyPartGroup == Data.BodyPartGroupDefOf.Hands)
//                {
//                    RemoveHediffDefOn(pawn, Data.HediffDefOf.HandCuffed,
//                        pawn.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.LeftHand));
//                    RemoveHediffDefOn(pawn, Data.HediffDefOf.HandCuffed,
//                        pawn.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.RightHand));
//                }
//                if (bodyPartGroup == BodyPartGroupDefOf.Legs)
//                {
//                    RemoveHediffDefOn(pawn, Data.HediffDefOf.LegShackled,
//                        pawn.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.LeftLeg));
//                    RemoveHediffDefOn(pawn, Data.HediffDefOf.LegShackled,
//                        pawn.health.hediffSet.GetBodyPartRecord(BodyPartDefOf.RightLeg));
//                }
//            }
        ...
        public void RemoveHediffDefOn(Pawn pawn, HediffDef hediffDef, BodyPartRecord bodyPartRecord)
        {
            ...
            var hediff = pawn.health.hediffSet.hediffs.FirstOrDefault(diff => (
                (diff.Part == bodyPartRecord) && (diff.def == hediffDef)
            ));
            if (hediff == null)
            {
                return;
